...
The tool retrieves price information from OANDA and appends it onto a local sqllite database ("db") on a daily basis. It then uploads the appended db file to a S3 or S3-like server using boto3.<br/><br/><br/>
